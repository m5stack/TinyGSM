...
#ifndef SRC_TINYGSMNBIOT_H_
#define SRC_TINYGSMNBIOT_H_

#include "TinyGsmCommon.h"

#define TINY_GSM_MODEM_HAS_NBIOT
...
template <class modemType> class TinyGsmNBIOT {
  public:
    /*
     * SIM card functions
     */
